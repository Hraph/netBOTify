export declare function promiseTimeout(ms: number, promise: Promise<any>): Promise<{}>;
export declare function promiseAllTimeout(ms: number, promiseArray: Promise<any>[]): Promise<{}>;
